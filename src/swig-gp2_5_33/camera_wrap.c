...
SWIGINTERN PyObject *_wrap_Camera_wait_for_event(PyObject *self, PyObject *args) {
  ...
  resultobj = SWIG_Py_Void();
  {
    resultobj = SWIG_Python_AppendOutput(resultobj, PyInt_FromLong(*arg3), 1);
    if (*arg3 == GP_EVENT_FILE_ADDED || *arg3 == GP_EVENT_FOLDER_ADDED
      ...
      resultobj = SWIG_Python_AppendOutput(resultobj, PyString_FromString(*arg4), 1);
      free(*arg4);
    }
    else {
...
SWIGINTERN PyObject *_wrap_gp_camera_wait_for_event(PyObject *self, PyObject *args) {
  ...
  resultobj = SWIG_From_int((int)(result));
  {
    resultobj = SWIG_Python_AppendOutput(resultobj, PyInt_FromLong(*arg3), 0);
    if (*arg3 == GP_EVENT_FILE_ADDED || *arg3 == GP_EVENT_FOLDER_ADDED
      || *arg3 == GP_EVENT_FILE_CHANGED) {
      ...
      resultobj = SWIG_Python_AppendOutput(resultobj, PyString_FromString(*arg4), 0);
      free(*arg4);
    }
    else {
      SWIG_Py_INCREF(Py_None);
