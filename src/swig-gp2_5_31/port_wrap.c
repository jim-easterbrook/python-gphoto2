...
static PyTypeObject *SwigPyBuiltin___GPPort_type_create(PyTypeObject *type, PyTypeObject **bases, PyObject *dict) {
  ...
  PyType_Slot slots[] = {
    { Py_tp_init,                       (void *)_wrap_new_GPPort },
    { Py_tp_dealloc,                    (void *)_wrap_delete_GPPort_destructor_closure },
    ...
    { Py_tp_richcompare,                (void *)SwigPyBuiltin___GPPort_richcompare },
