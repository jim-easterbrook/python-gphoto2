...
static PyTypeObject *SwigPyBuiltin___CameraFile_type_create(PyTypeObject *type, PyTypeObject **bases, PyObject *dict) {
  ...
  PyType_Slot slots[] = {
    { Py_tp_init,                       (void *)_wrap_new_CameraFile },
    { Py_tp_dealloc,                    (void *)_wrap_delete_CameraFile_destructor_closure },
    ...
    { Py_tp_richcompare,                (void *)SwigPyBuiltin___CameraFile_richcompare },
