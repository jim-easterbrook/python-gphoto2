...
SWIGINTERN PyObject *_wrap_CameraList_find_by_name(PyObject *self, PyObject *args) {
  ...
  resultobj = SWIG_Py_Void();
  {
    resultobj = SWIG_Python_AppendOutput(resultobj, PyInt_FromLong(*arg2), 1);
  }
  if (alloc3 == SWIG_NEWOBJ) free((char*)buf3);
  return resultobj;
fail:
...
SWIGINTERN PyObject *_wrap_CameraList_get_name(PyObject *self, PyObject *args) {
  ...
  resultobj = SWIG_Py_Void();
  {
    resultobj = SWIG_Python_AppendOutput(resultobj, *arg3 ? PyString_FromString(*arg3) : SWIG_Py_Void(), 1)
    ;
  }
  return resultobj;
fail:
...
SWIGINTERN PyObject *_wrap_gp_list_find_by_name(PyObject *self, PyObject *args) {
  ...
  resultobj = SWIG_From_int((int)(result));
  {
    resultobj = SWIG_Python_AppendOutput(resultobj, PyInt_FromLong(*arg2), 0);
  }
  if (alloc3 == SWIG_NEWOBJ) free((char*)buf3);
  return resultobj;
fail:
...
SWIGINTERN PyObject *_wrap_gp_list_get_name(PyObject *self, PyObject *args) {
  ...
  resultobj = SWIG_From_int((int)(result));
  {
    resultobj = SWIG_Python_AppendOutput(resultobj, *arg3 ? PyString_FromString(*arg3) : SWIG_Py_Void(), 0)
    ;
  }
  return resultobj;
fail:
