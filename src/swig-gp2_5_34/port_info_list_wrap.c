...
#define SWIGTYPE_p__GPPortInfo swig_types[2]
#define SWIGTYPE_p__GPPortInfoList swig_types[3]
#define SWIGTYPE_p_char swig_types[4]
#define SWIGTYPE_p_p__GPPortInfo swig_types[5]
#define SWIGTYPE_p_p__GPPortInfoList swig_types[6]
...
SWIGINTERN void _GPPortInfo_get_name(struct _GPPortInfo *self,char **name){
    ...
    int result = gp_port_info_get_name (self, name);
...
SWIGINTERN void _GPPortInfo_get_path(struct _GPPortInfo *self,char **path){
    ...
    int result = gp_port_info_get_path (self, path);
...
SWIGINTERN void _GPPortInfo_get_type(struct _GPPortInfo *self,GPPortType *type){
    ...
    int result = gp_port_info_get_type (self, type);
...
SWIGINTERN int _GPPortInfoList___len__(struct _GPPortInfoList *self){



    int result = gp_port_info_list_count (self);
...
SWIGINTERN void _GPPortInfoList_append(struct _GPPortInfoList *self,GPPortInfo info){
    ...
    int result = gp_port_info_list_append (self, info);
...
SWIGINTERN void _GPPortInfoList_load(struct _GPPortInfoList *self){
    ...
    int result = gp_port_info_list_load (self);
...
SWIGINTERN int _GPPortInfoList_count(struct _GPPortInfoList *self){
...
SWIGINTERN int _GPPortInfoList_lookup_path(struct _GPPortInfoList *self,char const *path){



    int result = gp_port_info_list_lookup_path (self, path);
...
SWIGINTERN int _GPPortInfoList_lookup_name(struct _GPPortInfoList *self,char const *name){



    int result = gp_port_info_list_lookup_name (self, name);
...
SWIGINTERN void _GPPortInfoList_get_info(struct _GPPortInfoList *self,int const n,GPPortInfo *info){
    ...
    int result = gp_port_info_list_get_info (self, n, info);
...
SWIGINTERN PyObject *_wrap_GPPortInfo_get_type(PyObject *self, PyObject *args) {
  ...
  if (SWIG_IsTmpObj(res2)) {
    ...
    resultobj = SWIG_Python_AppendOutput(resultobj, SWIG_NewPointerObj((void*)(arg2), SWIGTYPE_p_GPPortType, new_flags), 1);
  }
  return resultobj;
fail:
  return NULL;
...
SWIGINTERN PyObject *_wrap_GPPortInfoList___getitem__(PyObject *self, PyObject *args) {
  ...
  resultobj = SWIG_Py_Void();
  {
    resultobj = SWIG_Python_AppendOutput(resultobj, SWIG_NewPointerObj(*arg3, SWIGTYPE_p__GPPortInfo, 0), 1)
    ;
  }
  return resultobj;
fail:
...
SWIGINTERN PyObject *_wrap_gp_port_info_get_type(PyObject *self, PyObject *args) {
  ...
  if (SWIG_IsTmpObj(res2)) {
    ...
    int new_flags = SWIG_IsNewObj(res2) ? (SWIG_POINTER_OWN |  0 ) :  0 ;
    resultobj = SWIG_Python_AppendOutput(resultobj, SWIG_NewPointerObj((void*)(arg2), SWIGTYPE_p_GPPortType, new_flags), 0);
  }
  return resultobj;
fail:
  return NULL;
...
SWIGINTERN PyObject *_wrap_gp_port_info_list_new(PyObject *self, PyObject *args) {
  ...
  resultobj = SWIG_From_int((int)(result));
  {
    resultobj = SWIG_Python_AppendOutput(resultobj, SWIG_NewPointerObj(*arg1, SWIGTYPE_p__GPPortInfoList, SWIG_POINTER_OWN), 0)
    ;
  }
  return resultobj;
fail:
...
SWIGINTERN PyObject *_wrap_gp_port_info_list_get_info(PyObject *self, PyObject *args) {
  ...
  resultobj = SWIG_From_int((int)(result));
  {
    resultobj = SWIG_Python_AppendOutput(resultobj, SWIG_NewPointerObj(*arg3, SWIGTYPE_p__GPPortInfo, 0), 0)
    ;
  }
  return resultobj;
fail:
...
SWIGINTERN PyObject *_wrap_gp_port_init_localedir(PyObject *self, PyObject *args) {
  PyObject *resultobj = 0;
  char *arg1 = 0 ;
  int res1 ;
  char *buf1 = 0 ;
...
static PyTypeObject *SwigPyBuiltin___GPPortInfo_type_create(PyTypeObject *type, PyTypeObject **bases, PyObject *dict) {
  PyObject *tuple_bases;
  PyTypeObject *pytype = (PyTypeObject *)&SwigPyBuiltin___GPPortInfo_type;
  pytype->tp_dict = dict;
...
static PyTypeObject *SwigPyBuiltin___GPPortInfo_type_create(PyTypeObject *type, PyTypeObject **bases, PyObject *dict) {
  ...
  PyType_Spec spec = {
    "gphoto2.port_info_list.GPPortInfo",
    sizeof(SwigPyObject),
    0,
    Py_TPFLAGS_DEFAULT|Py_TPFLAGS_BASETYPE,
    slots
...
#endif
SWIGINTERN SwigPyClientData SwigPyBuiltin___GPPortInfo_clientdata = {0, 0, 0, 0, 0, 0, 0};
...
SWIGINTERN PyGetSetDef SwigPyBuiltin___GPPortInfoList_getset[] = {
    { (char *)"__dict__", SwigPyBuiltin_GetterClosure, 0, (char *)"dictionary for instance variables", &GPPortInfoList___dict___getset },
    { NULL, NULL, NULL, NULL, NULL } /* Sentinel */
};
...
SWIGINTERN PyObject *SwigPyBuiltin___GPPortInfoList_pyinit_wrapper(PyObject *self, PyObject *args, PyObject *kwargs) {
  if (_wrap_new_GPPortInfoList(self, args, kwargs) < 0) return NULL;
  Py_RETURN_NONE;
}

SWIGINTERN PyMethodDef SwigPyBuiltin___GPPortInfoList_pyinit_methoddef = {
  "__init__", (PyCFunction)(void(*)(void))SwigPyBuiltin___GPPortInfoList_pyinit_wrapper, METH_VARARGS|METH_KEYWORDS, "\n"
		"__init__(self) -> GPPortInfoList\n"
		"GPPortInfoList:  \n"
		"\n"
		"The internals of this list are private.\n"
		""
...
static PyTypeObject *SwigPyBuiltin___GPPortInfoList_type_create(PyTypeObject *type, PyTypeObject **bases, PyObject *dict) {
  PyObject *tuple_bases;
  PyTypeObject *pytype = (PyTypeObject *)&SwigPyBuiltin___GPPortInfoList_type;
  pytype->tp_dict = dict;
  SwigPyBuiltin_SetMetaType(pytype, type);
  pytype->tp_new = PyType_GenericNew;
  tuple_bases = SwigPyBuiltin_InitBases(bases);
...
static PyTypeObject *SwigPyBuiltin___GPPortInfoList_type_create(PyTypeObject *type, PyTypeObject **bases, PyObject *dict) {
  PyType_Slot slots[] = {
    ...
    { Py_tp_hash,                       (void *)(hashfunc) SwigPyObject_hash },
    { Py_sq_length,                     (void *)(lenfunc) _wrap_GPPortInfoList___len___lenfunc_closure },
    { Py_sq_item,                       (void *)(ssizeargfunc) _wrap_GPPortInfoList___getitem___ssizeargfunc_closure },
    { 0, NULL }
  };
  PyType_Spec spec = {
    "gphoto2.port_info_list.GPPortInfoList",
    sizeof(SwigPyObject),
    0,
    Py_TPFLAGS_DEFAULT|Py_TPFLAGS_BASETYPE,
    slots
...
#endif
SWIGINTERN SwigPyClientData SwigPyBuiltin___GPPortInfoList_clientdata = {0, 0, 0, 0, 0, 0, 0};
...
SWIGINTERN int SWIG_mod_exec(PyObject *m) {
  ...
  builtin_pytype = SwigPyBuiltin___GPPortInfo_type_create(metatype, builtin_bases, d);
  if(!builtin_pytype) {
    return -1;
  }
  SwigPyBuiltin___GPPortInfo_clientdata.pytype = builtin_pytype;
  SWIG_Py_INCREF((PyObject *)builtin_pytype);
  if (PyModule_AddObject(m, "GPPortInfo", (PyObject *)builtin_pytype) != 0) {
  ...
  PyDict_SetItemString(d, "this", this_descr);
  PyDict_SetItemString(d, "thisown", thisown_descr);
  builtin_pytype = SwigPyBuiltin___GPPortInfoList_type_create(metatype, builtin_bases, d);
  if(!builtin_pytype) {
    return -1;
  }
  SwigPyBuiltin___GPPortInfoList_clientdata.pytype = builtin_pytype;
  SWIG_Py_INCREF((PyObject *)builtin_pytype);
  if (PyModule_AddObject(m, "GPPortInfoList", (PyObject *)builtin_pytype) != 0) {
    SWIG_Py_DECREF((PyObject *)builtin_pytype);
    return -1;
  }
  SwigPyBuiltin_AddPublicSymbol(public_interface, "GPPortInfoList");
  {
    PyObject *init_desc = PyDescr_NewMethod(builtin_pytype, &SwigPyBuiltin___GPPortInfoList_pyinit_methoddef);
  ...
  SWIG_Python_SetConstant(d, d == md ? public_interface : NULL, "GP_PORT_IP",SWIG_From_int((int)(GP_PORT_IP)));
  return 0;
}
