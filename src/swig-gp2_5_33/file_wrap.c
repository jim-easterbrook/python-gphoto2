...
SWIGINTERN void delete__CameraFile(struct _CameraFile *self){
    gphoto2_error(gp_file_unref(self));
  }
...
SWIGINTERN PyObject *_wrap_CameraFile_get_name_by_type(PyObject *self, PyObject *args) {
  ...
  resultobj = SWIG_Py_Void();
  {
    resultobj = SWIG_Python_AppendOutput(resultobj, *arg4 ? PyString_FromString(*arg4) : SWIG_Py_Void(), 1)
    ;
  }
  if (alloc2 == SWIG_NEWOBJ) free((char*)buf2);
  return resultobj;
...
SWIGINTERN PyObject *_wrap_gp_file_get_name_by_type(PyObject *self, PyObject *args) {
  ...
  resultobj = SWIG_From_int((int)(result));
  {
    resultobj = SWIG_Python_AppendOutput(resultobj, *arg4 ? PyString_FromString(*arg4) : SWIG_Py_Void(), 0)
    ;
  }
  if (alloc2 == SWIG_NEWOBJ) free((char*)buf2);
  return resultobj;
