...
SWIGINTERN PyObject *_wrap_CameraWidget_get_name(PyObject *self, PyObject *args) {
  ...
  resultobj = SWIG_Py_Void();
  {
    resultobj = SWIG_Python_AppendOutput(resultobj, *arg2 ? PyUnicode_FromString(*arg2) : SWIG_Py_Void(), 1)
    ;
  }
  return resultobj;
fail:
...
SWIGINTERN PyObject *_wrap_gp_widget_get_name(PyObject *self, PyObject *args) {
  ...
  resultobj = SWIG_From_int((int)(result));
  {
    resultobj = SWIG_Python_AppendOutput(resultobj, *arg2 ? PyUnicode_FromString(*arg2) : SWIG_Py_Void(), 0)
    ;
  }
  return resultobj;
fail:
