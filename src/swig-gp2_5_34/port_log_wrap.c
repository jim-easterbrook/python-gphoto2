...
SWIGINTERN PyObject *_wrap_Log_add_func(PyObject *self, PyObject *args) {
  ...
  resultobj = SWIG_From_int((int)(result));
  {
    ...
    resultobj = SWIG_Python_AppendOutput(resultobj, SWIG_NewPointerObj(_global_callback, SWIGTYPE_p_LogFuncItem, SWIG_POINTER_OWN), 0)
    ;
...
SWIGINTERN PyGetSetDef SwigPyBuiltin__LogFuncItem_getset[] = {
    { (char *)"__dict__", SwigPyBuiltin_GetterClosure, 0, (char *)"dictionary for instance variables", &LogFuncItem___dict___getset },
...
static PyHeapTypeObject SwigPyBuiltin__LogFuncItem_type = {
  {
    ...
    Py_TPFLAGS_DEFAULT|Py_TPFLAGS_BASETYPE, /* tp_flags */
    "Proxy of C LogFuncItem struct.",       /* tp_doc */
...
static PyTypeObject *SwigPyBuiltin__LogFuncItem_type_create(PyTypeObject *type, PyTypeObject **bases, PyObject *dict) {
  PyObject *tuple_bases;
  PyTypeObject *pytype = (PyTypeObject *)&SwigPyBuiltin__LogFuncItem_type;
  pytype->tp_dict = dict;
...
static PyTypeObject *SwigPyBuiltin__LogFuncItem_type_create(PyTypeObject *type, PyTypeObject **bases, PyObject *dict) {
  PyType_Slot slots[] = {
    ...
    { Py_tp_dealloc,                    (void *)(destructor) _wrap_delete_LogFuncItem_destructor_closure },
    { Py_tp_doc,                        (void *)"Proxy of C LogFuncItem struct." },
    { Py_tp_richcompare,                (void *)(richcmpfunc) SwigPyBuiltin__LogFuncItem_richcompare },
    { Py_tp_methods,                    (void *)SwigPyBuiltin__LogFuncItem_methods },
    { Py_tp_getset,                     (void *)SwigPyBuiltin__LogFuncItem_getset },
    { Py_tp_hash,                       (void *)(hashfunc) SwigPyObject_hash },
    { 0, NULL }
  };
  PyType_Spec spec = {
    "gphoto2.port_log.LogFuncItem",
    sizeof(SwigPyObject),
    0,
    Py_TPFLAGS_DEFAULT|Py_TPFLAGS_BASETYPE,
    slots
...
#endif
SWIGINTERN SwigPyClientData SwigPyBuiltin__LogFuncItem_clientdata = {0, 0, 0, 0, 0, 0, 0};

static SwigPyGetSet Log___dict___getset = { SwigPyObject_get___dict__, 0 };
SWIGINTERN PyGetSetDef SwigPyBuiltin__Log_getset[] = {
    { (char *)"__dict__", SwigPyBuiltin_GetterClosure, 0, (char *)"dictionary for instance variables", &Log___dict___getset },
    { NULL, NULL, NULL, NULL, NULL } /* Sentinel */
};
...
static PyTypeObject *SwigPyBuiltin__Log_type_create(PyTypeObject *type, PyTypeObject **bases, PyObject *dict) {
  PyObject *tuple_bases;
  PyTypeObject *pytype = (PyTypeObject *)&SwigPyBuiltin__Log_type;
  pytype->tp_dict = dict;
  SwigPyBuiltin_SetMetaType(pytype, type);
  pytype->tp_new = PyType_GenericNew;
  tuple_bases = SwigPyBuiltin_InitBases(bases);
...
static PyTypeObject *SwigPyBuiltin__Log_type_create(PyTypeObject *type, PyTypeObject **bases, PyObject *dict) {
  PyType_Slot slots[] = {
    ...
    { Py_tp_doc,                        (void *)"Proxy of C Log struct." },
    { Py_tp_richcompare,                (void *)(richcmpfunc) SwigPyBuiltin__Log_richcompare },
    { Py_tp_methods,                    (void *)SwigPyBuiltin__Log_methods },
    { Py_tp_getset,                     (void *)SwigPyBuiltin__Log_getset },
    { Py_tp_hash,                       (void *)(hashfunc) SwigPyObject_hash },
    { 0, NULL }
  };
  PyType_Spec spec = {
    "gphoto2.port_log.Log",
    sizeof(SwigPyObject),
    0,
    Py_TPFLAGS_DEFAULT|Py_TPFLAGS_BASETYPE,
    slots
...
#endif
SWIGINTERN SwigPyClientData SwigPyBuiltin__Log_clientdata = {0, 0, 0, 0, 0, 0, 0};
...
SWIGINTERN int SWIG_mod_exec(PyObject *m) {
  ...
  builtin_pytype = SwigPyBuiltin__LogFuncItem_type_create(metatype, builtin_bases, d);
  if(!builtin_pytype) {
    return -1;
  }
  SwigPyBuiltin__LogFuncItem_clientdata.pytype = builtin_pytype;
  SWIG_Py_INCREF((PyObject *)builtin_pytype);
  if (PyModule_AddObject(m, "LogFuncItem", (PyObject *)builtin_pytype) != 0) {
  ...
  PyDict_SetItemString(d, "this", this_descr);
  PyDict_SetItemString(d, "thisown", thisown_descr);
  builtin_pytype = SwigPyBuiltin__Log_type_create(metatype, builtin_bases, d);
  if(!builtin_pytype) {
    return -1;
  }
  SwigPyBuiltin__Log_clientdata.pytype = builtin_pytype;
  SWIG_Py_INCREF((PyObject *)builtin_pytype);
  if (PyModule_AddObject(m, "Log", (PyObject *)builtin_pytype) != 0) {
    SWIG_Py_DECREF((PyObject *)builtin_pytype);
    return -1;
  }
